...
--%></head>
	...
	<form id="form" name="form" method="post" action="hsp/hspConfigBaseinfoUpdate.do">
		...
		<h2><img src="<%=request.getContextPath()%>/include/images/list.jpg" /><span style="vertical-align: middle;padding-left: 6px;">修改卫生机构</span></h2>
		<table  align="center" border="0" cellpadding="0" cellspacing="0" class="tblFill" id="xx">
			...
			<tr>
				...
				<td>
					<input type="hidden" name="itemCode" maxlength="50"
						   onkeydown="huiche()"
				...
				<td>
					<input type="hidden" name="seqNo"  onblur=""
			...
			<!-- Sheet operation button area -->
              <div class="btnSave">
						<img src="<%= request.getContextPath()%>/include/images/revise.jpg" name="btnSave" id="btnSave" style="cursor: pointer;" onclick="saveForm();" />
	...
	<script language="javascript">
		...
		function saveForm(){
			...
			pop_win_setTitle("是否确定修改",function(){
				...
				$.ajax({
					dataType: "text",
					type:"POST",
					url:"<%=request.getContextPath()%>/hsp/hspConfigBaseinfoUpdate.do",
					processData:true,
					data:formData,
